...
def get_envato_link(item_url: str) -> str:
    ...
    chrome_options.add_argument("--no-sandbox")  # Necesario para entornos restringidos como contenedores Docker
    chrome_options.add_argument("--disable-dev-shm-usage")  # Solución para evitar problemas de memoria compartida
    chrome_options.add_argument("--headless")  # Ejecutar Chrome en modo headless
    chrome_options.add_argument("--disable-gpu")  # Opcional: desactiva la aceleración de GPU
